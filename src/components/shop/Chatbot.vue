  ...
  <v-container>
    <v-row>
      <v-col md="12" cols="12">
        <div class="chatbot">
          <v-col>
            <v-btn icon class="copy-btn" @click="copyChatContent">
...
// API-Key für OpenAI
const apiKey =
  "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";
...
const sendMessage = async () => {
  ...
  try {
        ...
        messages: [
          {
            role: "system",
            content:
              "Du bist ein Logistik-Experte. Deine Aufgabe ist es, Fragen zu Themen wie Inbound, Outbound, Lagerung und Supply Chain zu beantworten. Erkläre bitte kurz und präzise. Du bist auch ein Experte in der Informatik und kannst mich bei allen anliegen rund um das Programmieren von Softwarelösungen helfen.",
          },
    ...
    messages.value.push({
      id: Date.now() + 1,
      sender: "Bot",
      text: "Darauf weiß ich keine Antwort.",
    });
  }

<template>
  ...
  <v-dialog v-model="dialog" max-width="500px">
    <v-card>
      <v-card-title>{{ dialogMode === 'add' ? 'Add User' : 'Edit User' }}</v-card-title>

      <v-card-text>
        <v-form v-model="formValid">
          <v-text-field v-model="form.name" label="Name" :rules="[rules.required]" required></v-text-field>
          <v-text-field v-model="form.email" label="Email" :rules="[rules.required, rules.email]" required></v-text-field>
          <v-text-field v-model="form.role" label="Role" :rules="[rules.required]" required></v-text-field>
        </v-form>
      </v-card-text>

      <v-card-actions>
        <v-btn text @click="closeDialog">Cancel</v-btn>
        <v-btn color="primary" @click="saveUser" :disabled="!formValid">{{ dialogMode === 'add' ? 'Add' : 'Save' }}</v-btn>
      </v-card-actions>
    </v-card>
  </v-dialog>
  </template>
  ...
  const users = ref([
    ...
    { id: 8, name: 'Charlie Davis', email: 'charlie16@example.com', role: 'Super-User' },
    ...
    { id: 12, name: 'Charlie Davis', email: 'charlie87@example.com', role: 'User' },
    { id: 13, name: 'Grace Lee', email: 'grace36@example.com', role: 'User' },
    { id: 14, name: 'John Doe', email: 'john3@example.com', role: 'Admin' },
    { id: 15, name: 'Hannah Clark', email: 'hannah21@example.com', role: 'Admin' },
    { id: 16, name: 'Alice Johnson', email: 'alice91@example.com', role: 'User' },
    { id: 17, name: 'Alice Johnson', email: 'alice49@example.com', role: 'Admin' },
    { id: 18, name: 'David Wilson', email: 'david21@example.com', role: 'Super-User' },
    { id: 19, name: 'Frank White', email: 'frank100@example.com', role: 'Super-User' },
    ...
    { id: 23, name: 'Jane Smith', email: 'jane88@example.com', role: 'Super-User' },
    ...
    { id: 28, name: 'Hannah Clark', email: 'hannah39@example.com', role: 'Super-User' },
    { id: 29, name: 'Jane Smith', email: 'jane86@example.com', role: 'Super-User' },
    { id: 30, name: 'Frank White', email: 'frank3@example.com', role: 'Super-User' },
  ]);

...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    AdminSidebar: typeof import('./components/admin/admin-components/AdminSidebar.vue')['default']
    ...
    ItemManagement: typeof import('./components/admin/admin-pages/ItemManagement.vue')['default']
    ...
    ThemeChanger: typeof import('./components/ThemeChanger.vue')['default']
